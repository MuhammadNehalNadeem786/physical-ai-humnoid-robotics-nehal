      ...
      <div className="container">
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            From core ROS 2 concepts to deploying robots powered by Vision-Language-Action models — following the same proven roadmap used by top AI robotics labs in 2025.
          </p>
        </div>
