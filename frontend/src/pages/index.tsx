        ...
        <div className={styles.container}>
          <div className={styles.contentCenter}>
            ...
            <p className={styles.description}>
              Learn to build intelligent humanoid robots from scratch using reinforcement learning,
              whole-body control, simulation (NVIDIA Isaac Sim, Gazebo), and real-world deployment.
              Taught through interactive Jupyter notebooks, videos, and hands-on projects.
            </p>
